...
var electivasArray = [
  "Seguridad en Sistemas de Información(Elec.)",
  "Tecnología y Gestión Web(Elec.)",
  "Comunicación Profesional(Elec.)",
  "Responsabilidad Social Institucional(Elec.)",
  "Emprendedorismo(Elec.)",
  "Sistemas de transmisión inalámbrica(Elec.)",
  "Actualización Tecnológica e Innovación(Elec.)",
  "Auditoría en Sistemas de Información(Elec.)",
  "Bioingeniería(Elec.)",
  "Tecnologías para la Explotación de la Información(Elec.)",
  ...
  "Modelos de Calidad en la Industria del Software(Elec.)",
  "Protocolos y Seguridad en redes inalámbricas(Elec.)",
  "Tecnología de Información para la Gestión Empresarial(Elec.)",
  "Ingeniería en Calidad(Elec.)",
];

var electivasObjeto = {
  "Seguridad en Sistemas de Información(Elec.)": 2,
  ...
  "Modelos de Calidad en la Industria del Software(Elec.)": 2,
  "Protocolos y Seguridad en redes inalámbricas(Elec.)": 2,
  "Tecnología de Información para la Gestión Empresarial(Elec.)": 2,
